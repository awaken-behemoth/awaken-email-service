...
class Email(object):
    ...
    def get_message():
        ...
        """
        raise NotImplementedError("get message must be implemented on all email Instances Email");
    
    @abstractmethod
    def get_subject():
        raise NotImplementedError("get subject must be implemented on all email Instances of Email");
